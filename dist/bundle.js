(function (factory) {
	  ...
	  const a = function (t, e) {
	    ...
	    if (s && s.length > 2) {
	      ...
	      for (; a.length || o.length;) {
	        ...
	        if (a = a.filter(t => !(t.edge.ymax <= r)), a.sort((t, e) => t.edge.x === e.edge.x ? 0 : (t.edge.x - e.edge.x) / Math.abs(t.edge.x - e.edge.x)), a.length > 1) for (let t = 0; t < a.length; t += 2) {
	          const e = t + 1;
	          if (e >= a.length) break;
	          const s = a[t].edge,
	                o = a[e].edge;
	...
	class i {
	  ...
	  connectingLines(t, s) {
	    const n = [];
	    if (s.length > 1) for (let o = 1; o < s.length; o++) {
	      const a = s[o - 1];
	      if (e(a) < 3) continue;
	      const r = [s[o][0], a[1]];
	  ...
	  dashedLine(t, s) {
	    ...
	    return t.forEach(t => {
	      ...
	      for (let t = 0; t < h; t++) {
	        const e = t * (n + o),
	              r = e + n,
	              h = [c[0] + e * Math.cos(u) + i * Math.cos(u), c[1] + e * Math.sin(u) + i * Math.sin(u)],
	              l = [c[0] + r * Math.cos(u) + i * Math.cos(u), c[1] + r * Math.sin(u) + i * Math.sin(u)];
	  ...
	  zigzagLines(t, s, n) {
	    ...
	    return t.forEach(t => {
	      ...
	      for (let t = 0; t < r; t++) {
	        const e = 2 * t * s,
	              a = 2 * (t + 1) * s,
	              r = Math.sqrt(2 * Math.pow(s, 2)),
	              i = [h[0] + e * Math.cos(c), h[1] + e * Math.sin(c)],
	              l = [h[0] + a * Math.cos(c), h[1] + a * Math.sin(c)],
	              u = [i[0] + r * Math.cos(c + Math.PI / 4), i[1] + r * Math.sin(c + Math.PI / 4)];
	...
	function b(t) {
	  ...
	  for (; !k(a, 2);) {
	    ...
	    } else k(a, 1) ? r = M[n] : (o++, r = M[a.text], n = a.text);

	    if (!(o + r < s.length)) throw new Error("Path data ended short");

	    for (let t = o; t < o + r; t++) {
	      const e = s[t];
	      if (!k(e, 1)) throw new Error("Param not a number: " + n + "," + e.text);
	      h[h.length] = +e.text;
	    }
	      ...
	      case "S":
	        {
	          let t = 0,
	              a = 0;
	          "C" === s || "S" === s ? (t = n + (n - h), a = o + (o - i)) : (t = n, a = o), e.push({
	            key: "C",
	            data: [t, a, ...l]
	          }), h = l[0], i = l[1], n = l[2], o = l[3];
	          break;
	        }
	      ...
	      case "A":
	        {
	          ...
	          if (0 === t || 0 === s) e.push({
	            ...
	            P(n, o, i, c, t, s, a, r, h).forEach(function (t) {
	              e.push({
	                key: "C",
	                data: t
	              });
	...
	function P(t, e, s, n, o, a, r, h, i, c) {
	  ...
	  if (c) [p, d, g, M] = c;else {
	    ...
	    const f = o * o,
	          ...
	          b = f * k - f * c * c - k * r * r,
	          y = f * c * c + k * r * r,
	          m = (h === i ? -1 : 1) * Math.sqrt(Math.abs(b / y));
	  ...
	  if (T[0] = 2 * L[0] - T[0], T[1] = 2 * L[1] - T[1], c) return [T, I, A].concat(f);
	  {
	    ...
	    for (let e = 0; e < f.length; e += 3) {
	      const s = w(f[e][0], f[e][1], l),
	            n = w(f[e + 1][0], f[e + 1][1], l),
	            o = w(f[e + 2][0], f[e + 2][1], l);
	...
	function L(t, e) {
	  let s = $(t, 1 * (1 + .2 * e.roughness), e);

	  if (!e.disableMultiStroke) {
	    const n = $(t, 1.5 * (1 + .22 * e.roughness), function (t) {
	...
	function I(t, e, s, n) {
	  ...
	  if (!s.disableMultiStroke) {
	    const [o] = q(n.increment, t, e, n.rx, n.ry, 1.5, 0, s),
	          a = G(o, null, s);
	    r = r.concat(a);
	  }
	...
	function $(t, e, s) {
	  ...
	  for (let o = 1; o < t.length; o++) n.push([t[o][0] + W(e, s), t[o][1] + W(e, s)]), o === t.length - 1 && n.push([t[o][0] + W(e, s), t[o][1] + W(e, s)]);
	...
	function F(t, e, s, n, o, a, r, h, i) {
	  ...
	  for (let a = c; a <= r; a += t) l.push([W(h, i) + e + n * Math.cos(a), W(h, i) + s + o * Math.sin(a)]);
	...
	function j(t, e, s, n, o, a, r, h) {
	  ...
	  let l = [0, 0];
	  const u = h.disableMultiStroke ? 1 : 2;
	  ...
	  }), l = [o + W(c[f], h), a + W(c[f], h)], i.push({
	    op: "bcurveTo",
	    data: [t + W(c[f], h), e + W(c[f], h), s + W(c[f], h), n + W(c[f], h), l[0], l[1]]
	  });
	...
	function V(t, e, s, n) {
	  ...
	  if (function (t, e) {
	    const s = t[e + 0],
	          ...
	          o = t[e + 2],
	          a = t[e + 3];
	    let r = 3 * n[0] - 2 * s[0] - a[0];
	    r *= r;
	    let h = 3 * n[1] - 2 * s[1] - a[1];
	    h *= h;
	...
	class U {
	  ...
	  arc(t, e, s, n, o, a, r = !1, h) {
	    ...
	    if (r && i.fill) if ("solid" === i.fillStyle) {
	      ...
	      const p = (f - u) / r.curveStepCount,
	            d = [];

	      for (let t = u; t <= f; t += p) d.push([h + c * Math.cos(t), i + l * Math.sin(t)]);
	  ...
	  path(t, e) {
	    ...
	    const o = s.fill && "transparent" !== s.fill && s.fill !== K,
	          a = s.stroke !== K,
	...
	class Y {
	  ...
	  arc(t, e, s, n, o, a, r = !1, h) {
	    const i = this.gen.arc(t, e, s, n, o, a, r, h);
	...
	class et {
	  ...
	  fillSketch(t, e, s) {
	    ...
	    const o = t.createElementNS(tt, "path");
